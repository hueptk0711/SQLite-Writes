...
7. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/FRESH_ENGLISH_A5_PRIMARY_FEASIBILITY_SET.jsonl`
8. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/A4_DERIVED_REGRESSION_DIAGNOSTICS_A5.jsonl`
9. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/ORACLE_COLUMN_CONDITIONED_PRIMARY_RESULTS.jsonl`
10. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/ORACLE_A4_DERIVED_DIAGNOSTIC_RESULTS.jsonl`
11. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/A5_PRIMARY_INDEPENDENCE_AUDIT.json`
12. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/EVALUATOR_SEMANTICS_A5.json`
13. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/ACCEPTANCE_POLICY_A5.json`
14. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/OMIT_AND_CANDIDATE_MISS_FAILURE_POLICY_A5.json`
15. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/SOURCE_INPUT_MANIFEST.json`
16. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/SYNTHETIC_SQLITE_DB_MANIFEST.jsonl`
17. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/PACKAGE_FILE_INTEGRITY_MANIFEST.json`
18. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/DERIVED_ARTIFACT_MANIFEST.json`
19. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/STAGE7C_A5_LOCK.json`
20. `Stage7C_A5_ENGLISH_COLUMN_CONDITIONED_PHASE_O_PROTOCOL_FREEZE/VALIDATION_REPORT.md`

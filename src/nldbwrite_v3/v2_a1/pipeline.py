...
def run_mocked_pipeline(
    *,
    ...
    _, phase_o_hash = render_phase_o_prompt(question, inventory)
    ...
    _, phase_m_hash = render_phase_m_prompt(phase_o["operation"], inventory, slots)
    ...
    if db_path is None:
        return MockedPipelineResult("COMPILED", phase_o_hash, phase_m_hash, program.sql, None, "compiled_without_preflight")

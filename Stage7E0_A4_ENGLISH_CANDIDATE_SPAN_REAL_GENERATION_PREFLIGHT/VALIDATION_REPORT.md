...
```text
accepted_protocol_commit=fe90bf2183ea5eb812367f608997150788f6ad6e
...
python -m zipfile --test Stage7E0_A4_ENGLISH_CANDIDATE_SPAN_REAL_GENERATION_PREFLIGHT_PATCH1_FINAL_REVIEWER_PACKAGE_20260831.zip
```
